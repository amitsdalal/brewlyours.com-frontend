      ...
      <div className="container-wide relative z-10 flex flex-col items-center justify-center text-center py-16">
        <AnimatedSection>
          <h1 className="text-coffee-cream font-serif text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Brewlyours – <span className="text-coffee-accent">Truly Yours</span>: Instant Coffee Experience
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-coffee-accent text-coffee-cream hover:bg-coffee-dark/50 font-medium text-lg px-8 py-6"
            >
              <a 
                href="#about"
                className="flex items-center gap-2"
